...
const ProductItem = (props) => {
  ...
  //console.log(product)
  return (
    <div className="text-sm p-2 h-[240px] flex flex-col justify-between bg-white shadow-lg shadow-[#cdcdcd] hover:shadow-[#AAAAAA] hover:scale-110 duration-200 cursor-pointer rounded-lg mb-3 border-t border-[#F2F2F2] lg:h-[310px] lg:text-[16px]" onClick={() => {showIndProduct(product)}}>
