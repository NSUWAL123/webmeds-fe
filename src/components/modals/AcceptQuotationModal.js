...
const AcceptQuotationModal = (props) => {
  ...
  let khalticonfig = {
    ...
    eventHandler: {
      async onSuccess(payload) {
        ...
        const updatedOrder = {...order, isPriceAccepted: "accepted", paymentType: "khalti", paymentStatus: true}

        const initiateOrder = await axios.put(
  ...
  const acceptQuotation = async () => {
    ...
    // endpoint hit to backend to initiate order
