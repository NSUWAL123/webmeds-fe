...
const EditNote = (props) => {
  ...
  const EditNote = async (id, title, description) => {
    // console.log("Edit note bhitra ko" + id, title, desc)
    let response = await axios.post(`http://localhost:5000/notes/update/${id}`, {
        title, description
    }, config);
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className="mt-2">
                      ...
                      <div className="mb-4 flex flex-col">
                        ...
                        <input type="text" className="border p-1" value={title}
